...
#define CONFIG_WIFI_STA_UPLINK 1
#define CONFIG_MQTT_HOMEASSISTANT 1
#define CONFIG_MQTT_HA_BUFFER_SIZE 1024
#define CONFIG_MQTT_DEFAULT_INTERVAL 30
...
#define CONFIG_LWIP_DHCPS_MAX_STATION_NUM 16
