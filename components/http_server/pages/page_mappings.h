...
#define PORTMAP_IFACE_OPTIONS "<option value='STA'>ETH (Ethernet)</option><option value='AP'>AP (WiFi AP)</option><option value='VPN'>VPN</option>"
#else
#define PORTMAP_IFACE_OPTIONS "<option value='STA'>STA (WiFi)</option><option value='AP'>AP (WiFi AP)</option><option value='VPN'>VPN</option>"
#endif
